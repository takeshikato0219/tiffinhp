...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* チャットウィンドウ */}
      {isOpen && (
        <div className="fixed bottom-24 left-4 md:left-6 z-50 w-[calc(100vw-2rem)] md:w-96 max-w-md h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col border border-gray-200">
          {/* ヘッダー */}
